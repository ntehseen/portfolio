  ...
  return (
    <LampContainer>
      ...
      >
        ...
        <p className="text-3xl py-4 ">This section includes Projects based on <br /> <span className="text-blue-400">Web Development</span>, <span className="text-rose-500">Machine Learning</span> , <span className="text-violet-400">Deep Learning</span> & <span className="text-lime-300">Data Science</span></p>
      </motion.h1>
    </LampContainer>
  );
}
